    ...
    <div>
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <button className="border border-purple-600 px-6 py-3 rounded-lg hover:bg-purple-600/10">
                Learn More
              </button>
            </div>
            <Stats stats={stats} />
      ...
      <section className="container mx-auto px-4 py-20">
        <div className="flex flex-col sm:flex-row justify-between items-center mb-12">
          ...
          <button className="text-purple-500 hover:text-purple-400">View All Properties</button>
        </div>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {properties.map(property => (
            <div key={property.id} className="bg-gray-900 rounded-xl overflow-hidden">
              <img 
                src={property.image} 
                alt={property.title}
              ...
              <div className="p-6">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
                  ...
                  <button className="bg-purple-600 px-4 py-2 rounded-lg hover:bg-purple-700 w-full sm:w-auto">
      ...
      <section className="container mx-auto px-4 py-20">
        <div className="flex flex-col sm:flex-row justify-between items-center mb-12">
          ...
          <button className="text-purple-500 hover:text-purple-400">View All Testimonials</button>
        </div>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {testimonials.map(testimonial => (
            <div key={testimonial.id} className="bg-gray-900 p-8 rounded-xl">
